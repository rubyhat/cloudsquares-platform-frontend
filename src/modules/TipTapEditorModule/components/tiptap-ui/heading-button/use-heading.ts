...
// --- Icons ---
import { HeadingOneIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/heading-six-icon";
