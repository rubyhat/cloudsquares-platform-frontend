...
): Record<ListType, string> => {
  return {
    bulletList: t("tipTapEditor.toolbar.listBullet"),
    orderedList: t("tipTapEditor.toolbar.listOrdered"),
    taskList: t("tipTapEditor.toolbar.listTask"),
  };
};
