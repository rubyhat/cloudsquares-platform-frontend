...
// --- Icons ---
import { AlignCenterIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/align-right-icon";
...
export const textAlignLabels = (
  ...
  return {
    left: t("tipTapEditor.toolbar.alignLeft"),
    center: t("tipTapEditor.toolbar.alignCenter"),
    right: t("tipTapEditor.toolbar.alignRight"),
    justify: t("tipTapEditor.toolbar.alignJustify"),
  };
};
