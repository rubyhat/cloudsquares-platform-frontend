...
// --- Icons ---
import { ListIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/list-icon";
import { ListOrderedIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/list-ordered-icon";
import { ListTodoIcon } from "@/modules/TipTapEditorModule/components/tiptap-icons/list-todo-icon";

// --- Lib ---
import { isNodeInSchema } from "@/modules/TipTapEditorModule/lib/tiptap-utils";
...
export const listOptions = (
  ...
  return [
    {
      label: t("tipTapEditor.toolbar.listBullet"),
      type: "bulletList",
      icon: ListIcon,
    },
    {
      label: t("tipTapEditor.toolbar.listOrdered"),
      type: "orderedList",
      icon: ListOrderedIcon,
    },
    {
      label: t("tipTapEditor.toolbar.listTask"),
      type: "taskList",
      icon: ListTodoIcon,
    },
  ];
...
export function useListDropdownMenu(config?: UseListDropdownMenuConfig) {
  ...
  const filteredLists = React.useMemo(
    () => getFilteredListOptions(types, t),
    [types, t],
  );
  ...
  return {
    ...
    types,
    filteredLists,
    label: t("tipTapEditor.toolbar.list"),
